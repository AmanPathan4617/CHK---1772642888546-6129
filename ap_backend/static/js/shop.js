    ...
    async function getData(){
      try {
        ...
        const seed = [
          {make:'Toyota', model:'Corolla', year:2019, km:45000, fuel:'Petrol', trans:'Automatic', price:950000, location:'Delhi', createdAt:Date.now()-86400000*10, img:'https://images.unsplash.com/photo-1549924231-f129b911e442?q=80&w=800&auto=format&fit=crop'},
          {make:'Honda', model:'Civic', year:2018, km:52000, fuel:'Petrol', trans:'Manual', price:875000, location:'Mumbai', createdAt:Date.now()-86400000*20, img:'https://images.unsplash.com/photo-1493238792000-8113da705763?q=80&w=800&auto=format&fit=crop'},
          {make:'Hyundai', model:'i20', year:2021, km:22000, fuel:'Diesel', trans:'Manual', price:720000, location:'Bangalore', createdAt:Date.now()-86400000*5, img:'https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?q=80&w=800&auto=format&fit=crop'},
          {make:'Maruti', model:'Swift', year:2017, km:60000, fuel:'Petrol', trans:'AMT', price:520000, location:'Pune', createdAt:Date.now()-86400000*40, img:'https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=800&auto=format&fit=crop'}
        ];
        const mappedUser = user.map(d=>({
          ...d,
          km: Number(d.km||0),
    ...
    if(emiClose){ emiClose.addEventListener('click', ()=> emiModal.style.display='none'); }
